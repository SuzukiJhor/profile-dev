    ...
    <div>
      ...
      <div className="w-full h-[100vh] bg-white py-32 relative flex justify-center items-start space-x-32">
        ...
        <div className="w-[300px]">
          <h2 className="text-4xl font-bold text-[#08111A] mb-4">Arquitetura</h2>
        ...
        {/* Bloco Designer */}
        <div className="w-[300px]">
          <h2 className="text-4xl font-bold text-[#08111A] mb-4">Designer</h2>
          <p className="text-[#08111A] text-sm leading-relaxed opacity-80">
      ...
      <section className="w-full h-[100vh] bg-[#08111A] text-white py-32 px-24 flex justify-between">
        ...
        <div className="w-1/2 space-y-6">
          ...
          <h3 className="text-2xl font-bold text-[#CCF381] mt-6">Chega mais,</h3>
          <p className="text-white opacity-80">
            Gerencio tanto o Frontend quanto o Backend de sites e aplicações web, sempre com foco no sucesso do produto como um todo.
            Confira alguns dos meus trabalhos na seção de Projetos. Gosto de compartilhar conteúdos sobre o que aprendi ao longo dos anos
            em Desenvolvimento Web, para ajudar outras pessoas da comunidade dev. Sinta-se à vontade para se conectar ou me seguir no
            LinkedIn e Telegram, onde posto conteúdos úteis sobre Desenvolvimento Web e Programação.
          </p>
        </div>
        ...
        <div className="w-1/2 grid grid-cols-3 gap-4">
          {[
            'GIT', 'PHP', 'JavaScript',
            'Laravel', 'Nest.js', 'HTML',
            'Redis', 'Next.js', 'Wordpress',
            'SQL', 'SEO', 'CSS',
            'MongoDB', 'React.js', 'Node.js',
            'SASS', 'Angular', 'Vue.js'
          ].map((skill) => (
            <span key={skill} className="bg-[#CCF381] text-[#08111A] font-bold px-4 py-2 rounded-md text-center">
              {skill}
            </span>
          ))}
        </div>
      ...
      <section className="w-full h-[100vh] bg-white flex flex-col items-center justify-center py-32 px-24">
        <h2 className="text-4xl font-bold text-[#08111A] mb-4">Mande uma mensagem!</h2>
